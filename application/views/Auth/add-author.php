...
<head>
    ...
    <title>SDCA Library Management System | Add Author</title>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form method="post" action="<?php echo site_url('Auth/add_author'); ?>">
                                <div class="form-group">
                                    <label>Author Name</label>
                                    <input class="form-control" type="text" name="author_name" required>
                                </div>
                                <button type="submit" name="create" class="btn btn-danger"><i class="fa fa-plus"></i> Add Author</button>
                            </form>
                        </div>
                    </div>
                </div>
