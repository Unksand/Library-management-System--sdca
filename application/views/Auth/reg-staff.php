...
<head>
    ...
    <title>Registered Staff | Admin Dashboard</title>
...
<body>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line">Manage Registered Staff</h4>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Registered Staff</div>
                            ...
                            <tbody>
                                <?php foreach ($staff as $index => $s): ?>
                                    <tr>
                                        ...
                                        <td><?php echo $s->{'School Email'}; ?></td>
                                        <td><?php echo $s->{'Phone Number'}; ?></td>
                                        <td><?php echo $s->{'School Program'}; ?></td>
    ...
    <script src="<?php echo base_url('assets/js/jquery.10.2.js'); ?>"></script>
